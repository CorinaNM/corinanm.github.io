...
The app is built using the Shiny package for R. It includes several visualizations and filters created using the following packages: DT, shiny, shinyWidgets, shinythemes, shinyjs, bslib, bsicons, lubridate, leaflet, highcharter.... [Check out the shiny dashboard](https://corinanm.github.io/mysite/){target="_blank"}
:::
...
My teammate and I participated in Microsoft hackathon where we accessed data from APIs using Python, pulled the output in R using Reticulate and created visualizations to derive business insights using Ggplot2... [Check out how](https://corinanm.github.io/mysite/){target="_blank"}
:::
:::
...
This blog goes through examples and code to show how easy it is to use gganimate and plotly packages to animate your data visualizations and make them interactive.... [Continue reading](https://corinanm.github.io/mysite/){target="_blank"}
:::
...
Giving your stakeholders the ability to play with product grain forecast and anomaly detection is a great was to get them on-board prior to deploying any model at scale. This Shiny dashboard was built specifically for that purpose.... [Link to play with the Shiny dashboard](https://corinanm.github.io/mysite/){target="_blank"}
:::
:::
